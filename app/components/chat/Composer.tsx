...
export const Composer = forwardRef<ComposerHandle, ComposerProps>(function Composer(
  ...
  const SLASH_COMMANDS = [
    { name: 'shrug', desc: 'Appends ¯\\_(ツ)_/¯ to your message' },
    { name: 'tableflip', desc: 'Appends (╯°□°)╯︵ ┻━┻ to your message' },
    { name: 'unflip', desc: 'Appends ┬─┬ ノ( ゜-゜ノ) to your message' },
    { name: 'me', desc: 'Displays action text in italic (e.g. "/me waves")' },
    { name: 'status', desc: 'Set your custom status (text and emoji)' },
    { name: 'dnd', desc: 'Enable Do Not Disturb mode' },
    { name: 'mute', desc: 'Mute the current channel' },
    { name: 'unmute', desc: 'Unmute the current channel' },
    { name: 'remind', desc: 'Set a reminder (e.g. "/remind 30 Check email")' },
    { name: 'topic', desc: 'Set the channel topic/purpose' },
    { name: 'join', desc: 'Join a channel by name (e.g. "/join general")' },
    { name: 'invite', desc: 'Invite a user to this channel (e.g. "/invite @user")' },
    { name: 'archive', desc: 'Archive the current channel' },
    { name: 'unarchive', desc: 'Unarchive the current channel' },
    { name: 'rename', desc: 'Rename the current channel' },
    { name: 'who', desc: 'List members in the current channel' },
    { name: 'collapse', desc: 'Collapse all image & link previews' },
    { name: 'expand', desc: 'Expand all image & link previews' },
    { name: 'code', desc: 'Insert a code block' },
    { name: 'clear', desc: 'Clear the current draft' },
