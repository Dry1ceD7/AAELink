      ...
      {filteredItems.length === 0 ? (
        ...
        filteredItems.map(item => (
          <div
            ...
            onMouseEnter={e => { if (!selected.has(item.message_id)) (e.currentTarget as HTMLElement).style.background = 'rgba(128,128,128,0.04)' }}
            onMouseLeave={e => { if (!selected.has(item.message_id)) (e.currentTarget as HTMLElement).style.background = 'transparent' }}
          >
            {/* Selection checkbox */}
