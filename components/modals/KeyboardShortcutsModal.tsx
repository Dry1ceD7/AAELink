...
const GROUPS: { title: string; shortcuts: { keys: string; desc: string }[] }[] = [
  ...
  },
  {
    ...
    shortcuts: [
      { keys: 'J / ↓', desc: 'Move to the next message' },
      { keys: 'K / ↑', desc: 'Move to the previous message' },
      { keys: 'T', desc: 'Open thread on focused message' },
      { keys: 'E', desc: 'Edit focused message (your own only)' },
      { keys: 'R', desc: 'Open reaction picker on focused message' },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: `${MOD} + 1…9`, desc: 'Jump to Nth sidebar channel' },
      { keys: `${MOD} + Shift + H`, desc: 'Start or toggle huddle' },
    ]
  },
  ...(IS_DESKTOP ? [{
    title: 'Desktop',
